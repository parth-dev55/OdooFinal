...
export default function LoginPage() {
  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      navigate('/dashboard'); // Mock redirect based on role in a real app
    } catch (err: any) {
    ...
    <AuthSplitLayout>
      <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-100 shadow-xl shadow-purple-900/5">
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link to="/signup" className="font-semibold text-[#6D54B5] hover:text-purple-700 transition-colors">
            Create Account
          </Link>
        </div>
