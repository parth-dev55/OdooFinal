...
public class PaymentService {
    ...
    private Payment savePayment(RegisterPaymentRequest request, PaymentType type, VendorBill bill,
        ...
        payment.setPaymentNumber("PAY-" + java.util.UUID.randomUUID());
        ...
        payment.setParty(bill != null ? bill.getVendor() : invoice.getCustomer());
        payment.setPartyType(bill != null ? SalesPartyType.VENDOR : SalesPartyType.CUSTOMER);
