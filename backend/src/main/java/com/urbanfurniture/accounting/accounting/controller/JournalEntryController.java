...
public class JournalEntryController {
    ...
    @PutMapping("/{id}")
    public JournalEntryResponse updateDraft(@PathVariable @Positive Long id,
                                            @Valid @RequestBody UpdateJournalEntryRequest request) {
        return accountingService.updateDraft(id, request);
    }

    @PostMapping("/{id}/post")
    public JournalEntryResponse post(@PathVariable @Positive Long id) {
        return accountingService.post(id);
    }

    @PostMapping("/{id}/reverse")
    public JournalEntryResponse reverse(@PathVariable @Positive Long id) {
        return accountingService.reverse(id);
    }
}
