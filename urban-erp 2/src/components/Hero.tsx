    ...
    <section className="pt-16 pb-20 px-6 lg:px-12 text-center bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-20">
          <Link to="/workspace" className="w-full sm:w-auto px-6 py-2.5 rounded-full bg-[#6D54B5] text-white font-bold hover:bg-purple-700 transition-colors shadow-lg shadow-purple-200 text-center">
            Get Started
          </Link>
