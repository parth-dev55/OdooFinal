              ...
              <div className="lg:col-span-1">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mt-6">
                  ...
                  <div className="space-y-3">
                    <Link to="/dashboard/balance-sheet" className="flex items-center justify-between p-3 rounded-xl border border-gray-100 hover:border-[#6D54B5]/30 hover:bg-purple-50/50 transition-colors group">
                    ...
                    <Link to="/dashboard/profit-loss" className="flex items-center justify-between p-3 rounded-xl border border-gray-100 hover:border-[#6D54B5]/30 hover:bg-purple-50/50 transition-colors group">
                    ...
                    <Link to="/dashboard/budget-report" className="flex items-center justify-between p-3 rounded-xl border border-gray-100 hover:border-[#6D54B5]/30 hover:bg-purple-50/50 transition-colors group">
