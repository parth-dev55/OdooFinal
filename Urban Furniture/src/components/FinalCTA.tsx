      ...
      <div className="max-w-4xl mx-auto text-center rounded-[3rem] bg-[#6D54B5] text-white p-12 md:p-20 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/workspace" className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-white text-[#6D54B5] font-bold hover:bg-gray-50 transition-colors shadow-lg text-center">
              Get Started
            </Link>
            <Link to="/dashboard" className="w-full sm:w-auto px-8 py-3.5 rounded-full bg-purple-700 text-white font-medium border border-purple-500 hover:bg-purple-800 transition-colors text-center">
              Explore Dashboard
            </Link>
          </div>
        </div>
