  ...
  return (
    <nav className="flex items-center justify-between px-10 py-5 bg-white border-b border-gray-100">
      ...
      <div className="hidden lg:flex items-center gap-4">
        ...
        <Link to="/workspace" className="bg-[#6D54B5] text-white px-5 py-2 rounded-full text-[13px] font-semibold shadow-lg shadow-purple-200 hover:bg-purple-700 transition-colors">
          Get Started
        </Link>
      </div>
